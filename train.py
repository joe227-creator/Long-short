...
LOSS_TYPE = "cagr_cvar"     # Optimize arithmetic return with a differentiable downside-tail penalty.
...
TURN_PEN = 0.0               # Explicit fee replaces heuristic turnover penalty.
        ...
        while True:
            ...
            if LOSS_TYPE in _PORTFOLIO_LOSSES:
                ...
                if LOSS_TYPE in ("sharpe", "huber_sharpe"):
                    ...
                    loss = -mean_ret * RET_SCALE + fee_loss
